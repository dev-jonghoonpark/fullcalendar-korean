                    ...
                    while (leftCol <= rightCol) {
                        ...
                        if (dropdownContainer.length === 0) {
                            dropdownContainer = $('<div class="fc-popover dropdown">')
                                ...
                                .attr('id', 'dropdownMenu' + moreId);
                            var more = $('<a class="more_btn more_blue" type="button" href="#" data-toggle="dropdown" aria-expanded="true">');
                            var morePopup = $('<ul class="fc-pop-list dropdown-menu" role="menu" aria-labelledby="dropdownMenu' + moreId + '">');

                            dropdownContainer.append(more);
                            dropdownContainer.append(morePopup);

                            element.closest('.fc-event-container').append(dropdownContainer);

                            moreId++;
                        }

                        element.addClass('fc-event-more').removeAttr('style');
